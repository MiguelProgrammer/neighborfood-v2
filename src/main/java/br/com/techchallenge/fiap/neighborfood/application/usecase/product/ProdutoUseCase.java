...
package br.com.techchallenge.fiap.neighborfood.application.usecase.product;
...
public class ProdutoUseCase {
    ...
    public ProdutoUseCase(ProdutoGateway produtoGateway, UserGateway userGateway) {
    ...
    public Object findById(Long idProduto) {
        return produtoGateway.findById(idProduto);
    }

    public void deleteById(Long idProduto) {
        produtoGateway.deleteById(idProduto);
    }

    public void deleteAllExecute(Set<Produto> produtos) {
        produtoGateway.deleteAll(produtos);
    }
}
